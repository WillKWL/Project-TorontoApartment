...
- Initiated this project to improve upon existing solutions by identifying favorable neighborhoods to rent an apartment in based on 
  1) <ins>accessibility</ins>, 
  2) <ins>affordability</ins>, and 
  3) <ins>safety</ins>  
- Collected and scraped geospatial, rental and crime data from Toronto Police Services API, TRREB and TTC
- Prepared data sets with ETL workflow by cleaning, scaling and performing feature engineering with pandas and SQL
- Leveraged Tableau dashboards to visualize time trends and cross-sectional patterns among neighborhoods
- Modelled and predicted lease rates, crime rates and traffic collision rates with best-subset panel data regression
- Bootstrapped regression model to suggest statistical significance with F test despite violation in residual assumptions
